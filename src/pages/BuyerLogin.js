        ...
        <div style={styles.formCard}>
          <div style={styles.header}>
            ...
            <h1 style={styles.title}>
              {isLogin ? "Welcome Back" : "Join IsdaMarket"}
            </h1>
            <p style={styles.subtitle}>
              {isLogin ? "Login to browse fresh fish" : "Create your buyer account"}
            </p>
          </div>
          ...
          <div style={styles.footer}>
            <p style={styles.footerText}>
              {isLogin ? "Are you a seller?" : "Want to sell fish?"}{" "}
              <Link to="/seller-login" style={styles.footerLink}>
                Seller Login
              </Link>
            </p>
          </div>
